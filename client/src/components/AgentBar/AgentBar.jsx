...
const EXAMPLE_CHIPS = [
  ...
  { label: 'Solo: Bandra → Andheri',            value: 'Bandra to Andheri fastest, Mumbai' },
...
export default function AgentBar({ onIntentParsed, isParsing }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center">
      ...
      {/* Label — visually hidden but read by screen readers */}
      ...
      <div className="w-full relative group">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full glass-panel text-lg text-white placeholder-trazy-muted/60 pl-14 pr-16 py-5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-trazy-accent/60 disabled:opacity-50 shadow-2xl font-medium"
          ...
          <button
            ...
            className="absolute right-3 w-10 h-10 rounded-xl bg-trazy-accent disabled:opacity-30 flex items-center justify-center transition-all hover:bg-trazy-accentHover focus-ring"
          >
            {isParsing
      ...
      <p id="agent-bar-hint" className="sr-only">
        Type your trip details in plain English and press Enter or the arrow button.
      </p>
